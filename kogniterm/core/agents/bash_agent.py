...
class BashAgentRunner(SuperAgentRunner):
    """
    Motor asíncrono para BashAgent basado en SuperAgentRunner.
    Coordinación optimizada, streaming en tiempo real, confirmaciones Human-in-the-Loop
    y filtrado limpio de herramientas.
    """
