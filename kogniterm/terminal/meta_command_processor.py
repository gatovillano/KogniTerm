            ...
            if hasattr(self, 'kogniterm_app') and self.kogniterm_app:
                ...
                if os.path.exists(context_path) and not force:
                    ...
                    try:
                        ...
                        self.terminal_ui.print_message(f"❌ Error al iniciar la investigación de DeepResearcher: {e}", style="red")
                return True
        ...
        if user_input.lower().strip() == '/provider':
            ...
            if selected_provider:
                ...
                if selected_provider == "custom_openai":
                    ...
                    if not custom_openai_url:
                        custom_openai_url = "http://localhost:8387/v1"
