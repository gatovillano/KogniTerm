...
import { TaskPlans } from '@kogniterm/types';

export interface TaskTrackerProps {
  taskPlans: TaskPlans;
}

export const TaskTracker: React.FC<TaskTrackerProps> = ({ taskPlans }) => {
  ...
  return (
    <div className="flex flex-col w-full bg-zinc-900 border-l border-zinc-800 overflow-y-auto">
      <div className="p-4 border-b border-zinc-800 sticky top-0 bg-zinc-900/90 backdrop-blur-md z-10 flex items-center gap-2">
