...
async def test_kogniterm_tui_agent_tabs():
    ...
    async with app.run_test() as pilot:
        ...
        # Activate container so it is displayed and layout can occur
        app.activate_parallel_container()
        await pilot.pause()
        ...
        pane = app.query_one("#pane-test-agent-1", TabPane)
        ...
        with pytest.raises(Exception):
            app.query_one("#pane-test-agent-1", TabPane)
